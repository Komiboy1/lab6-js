/****************** YOUR NAME: OKONMAH EBUBECHUKWU VICTOR
...
/*  - first, create a variable to represent the "Change Duration" pseudo-button.
    - then, create a function called changeDuration() that will
        ...
        - parse the result of the prompt() to convert it into a number and save it to the duration variable
...
function changeDuration() {
    ...
    duration = Number(newDurationText); // Parse the input to convert it into a number
